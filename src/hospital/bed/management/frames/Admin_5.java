 ...
 * @author bonbo
 */
public class Admin_5 extends javax.swing.JFrame {

    static int hospID_five_edit;
    static String hospName_five_edit;
    
    public Admin_5() {
        initComponents();
        panelBorder2.initMoving(Admin_5.this);
    ...
    public void setHospitalInfoToTable() {
        ...
        try{
           ...
           while(rs.next()) {
                ...
                String covidPatients = rs.getString("covidBeds");
                String nonCovidPatients = rs.getString("nonCovidBeds");
               
               
               Object[] obj = {hospID, hospName, hospRegion, covidPatients, nonCovidPatients};
    ...
    private void initComponents() {
        ...
        jLabel6.setText("HOSPITAL BED CAPACITY MANAGEMENT");
        ...
        tableDark1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hospital ID", "Hospital Name", "Region", "Covid Beds", "Non Covid Beds"
            }
        ) {
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
         if (hospName_five_edit.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Select Hospital to edit");
        } else {
            Admin_5_edit a5e = new Admin_5_edit();
            a5e.setVisible(true);
            a5e.pack();
            a5e.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            this.dispose();
         }
    ...
    private void tableDark1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDark1MouseClicked
        ...
        hospID_five_edit = Integer.parseInt(jTextField1.getText());
        
        jTextField2.setText(model.getValueAt(rowNo, 1).toString());
        hospName_five_edit = jTextField2.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
