 ...
 * @author bonbo
 */
public class Admin_4 extends javax.swing.JFrame {

    static int hospID_four_edit;
    static String hospName_four_edit;
    
    public Admin_4() {
        initComponents();
        panelBorder1.initMoving(Admin_4.this);
    ...
    private void initComponents() {
        ...
        tableDark1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hospital ID", "Hospital Name", "Region", "Covid Patients", "Non Covid Patients"
            }
        ) {
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        if (hospName_four_edit.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Select Hospital to edit");
        } else {
            Admin_4_edit a4a = new Admin_4_edit();
            a4a.setVisible(true);
            a4a.pack();
            a4a.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            this.dispose();
        }
    ...
    private void tableDark1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDark1MouseClicked
        ...
        hospID_four_edit = Integer.parseInt(jTextField1.getText());
        
        jTextField2.setText(model.getValueAt(rowNo, 1).toString());
        hospName_four_edit = jTextField2.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
