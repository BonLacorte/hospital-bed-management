...
public class Admin_3 extends javax.swing.JFrame {
    ...
    static int regionID_edit;
    
    public Admin_3() {
        initComponents();
        panelBorder1.initMoving(Admin_3.this);
    ...
    public void setRegionToTable() {
        ...
        try{
           ...
           while(rs.next()) {
               ...
               Object[] obj = {regionID, regionName};
    ...
    private void initComponents() {
        ...
        jLabel6.setText("REGION MANAGEMENT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
