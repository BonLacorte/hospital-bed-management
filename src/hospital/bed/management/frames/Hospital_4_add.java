...
public class Hospital_4_add extends javax.swing.JFrame {

    static String patientType;
    
    public Hospital_4_add() {
        initComponents();
        panelBorder1.initMoving(Hospital_4_add.this);
        
        jTextField1.setEnabled(false);
        
        System.out.println("I am at hospital 4 add " +userID);
    }
    ...
    public boolean addPatient() {
        ...
        patientType = jComboBox1.getSelectedItem().toString();
        ...
        if (verifyFields()) {
            try {
                ...
                String query = "INSERT INTO hospital_bed.patient_information (patientName, patientType, patientStatus, patientContact, patientAddress, age, sex, symptoms, requestBy) VALUES(?,?,?,?,?,?,?,?,?)";
                PreparedStatement ps = con.prepareStatement(query);
                //ps.setInt(1, requestID);
                ps.setString(1, patientName);
                ps.setString(2, patientType);
                ps.setString(3, patientStatus);
    ...
    // update covid patient count
    /* 
        if patientType == "Covid" {
            try {
                connect, update .hospital_information 
    ...
    */
    ...
    public boolean verifyFields() 
    {
        ...
        String patName = jTextField2.getText();
        String hospType = jComboBox2.getSelectedItem().toString();
        String age = jTextField8.getText();
        String patContact = jTextField5.getText();
        String hospRegion = jComboBox1.getSelectedItem().toString();
        String patAddress = jTextField7.getText();
    
        //hospID.trim().equals("")|| 
        // check empty fields
        if(patName.trim().equals("")|| age.trim().equals("")|| patContact.trim().equals("") || patAddress.trim().equals("")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hospital_4_add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hospital_4_add().setVisible(true);
            }
        });
    }
